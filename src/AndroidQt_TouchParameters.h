...
enum PressedMouseButton{
    Pressed_Nothing,Pressed_LeftButton,Pressed_RightButton,Pressed_MiddleButton,Pressed_LeftButton_RightButton
};
enum ReleasedMouseButton{
    Released_Nothing,Released_LeftButton,Released_RightButton,Released_MiddleButton
};
